    ...
    <main className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary items-center justify-center p-12">
        <div className="max-w-md text-primary-foreground">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold">QuickServe</span>
          </div>
          <h2 className="text-4xl font-bold mb-4">
            Book trusted home services in minutes
          </h2>
          <p className="text-lg opacity-90 mb-8">
            Plumbing, cleaning, electrical, beauty services and more — all at your fingertips.
          </p>
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-primary-foreground/20 flex items-center justify-center text-sm font-semibold">✓</div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-background">
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSubmit} aria-label="Customer login form">
          ...
          <p className="text-center text-xs text-muted-foreground mt-4">
            ...
            <Link to="/provider/login" className="text-primary hover:underline underline-offset-4">
              Login here
            </Link>
          </p>
        </div>
